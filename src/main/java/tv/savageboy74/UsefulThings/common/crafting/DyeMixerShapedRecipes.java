...
public class DyeMixerShapedRecipes implements IRecipe
{
    ...
    public DyeMixerShapedRecipes(int par1, int par2, ItemStack[] par3ArrayOfItemStack, ItemStack par4ItemStack)
    {
    ...
    public DyeMixerShapedRecipes func_92100_c()
    {
